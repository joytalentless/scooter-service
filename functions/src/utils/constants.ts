...
export const tierApiUrl = "https://platform.tier-services.io/v1/vehicle?zoneId=OSLO";
export const tierPricingApiUrl = "https://platform.tier-services.io/v1/pricing";
export const voiApiUrlOslo = "https://mds.voiapp.io/v1/gbfs/en/27/free_bike_status";
export const voiApiUrlTrondheim = "https://mds.voiapp.io/v1/gbfs/en/196/free_bike_status";
export const voiSessionKeyUrl = "https://mds.voiapp.io/token";
export const zvippApiUrlDrammen = "https://zvipp-api.joyridecity.bike/gbfs/en/free_bike_status.json?operator_id=67";
...
export const scooterPrices: priceTexts = {
    voi: formatPriceToText(defaultScooterPrice.startPrice, defaultScooterPrice.pricePerMinute),
    tier: formatPriceToText(defaultScooterPrice.startPrice, defaultScooterPrice.pricePerMinute),
