...
async function boltRequest(url: string, token: string): Promise<any> {
                        ...
                        feeds: [
                            {
                                ...
                                url: `https://api.staging.entur.io/mobility/v1/gbfs-boltoslo/gbfs/system_information`,
                            },
                            {
                                name: 'vehicle_types',
                                url: `https://api.staging.entur.io/mobility/v1/gbfs-boltoslo/gbfs/vehicle_types`,
                            },
                            {
                                name: 'free_bike_status',
                                url: `https://api.staging.entur.io/mobility/v1/gbfs-boltoslo/gbfs/free_bike_status`,
                            },
                            {
                                name: 'system_regions',
                                url: `https://api.staging.entur.io/mobility/v1/gbfs-boltoslo/gbfs/system_regions`,
                            },
                            {
                                name: 'system_pricing_plans',
                                url: `https://api.staging.entur.io/mobility/v1/gbfs-boltoslo/gbfs/system_pricing_plans`,
                            },
                        ],
                    },
                },
...
app.get(
    ...
    async (req, res): Promise<void> => {
        try {
            const { last_updated, ttl, data }: any = await boltRequest(
                'https://mds.bolt.eu/gbfs/1/74/free_bike_status',
                await getToken(),
            )
